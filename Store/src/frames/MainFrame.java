...
public class MainFrame extends JFrame implements ActionListener
{
	...
	public void createMenus( )
	{
		...
		pan.addObject(0, 0, 1.0, 0.0, 1, 4, scpProducts);
		pan.addObject(1, 0, 0.0, 0.0, 1, 1, btnAddProduct);
		pan.addSizing(1, 2, 0.0, 1.0, 1, 1, 0, 10);
		pan.addObject(0, 4, 1.0, 0.0, 1, 6, scpCartProducts);

		pan.addObject(1, 4, 0.0, 0.0, 1, 1, btnCloseCart);
		pan.addObject(1, 5, 0.0, 0.0, 1, 1, btnEditQuantity);
		pan.addObject(1, 6, 0.0, 0.0, 1, 1, btnDeleteCartProduct);
		pan.addObject(1, 1, 0.0, 0.0, 1, 1, btnRefresh);
		pan.addSizing(2, 7, 0.0, 0.0, 1, 1, 0, 0);
		setContentPane(pan);
