...
public class WaitForAllocationDialog extends JDialog implements ActionListener
{
	...
	private void setupGUI( )
	{
		...
		RequestProductThread thread = new RequestProductThread(this, prodReq, context, stop);
		thread.start();
	...
	public void actionPerformed( ActionEvent e )
	{
		...
		{
			if (prodReq.getStatus() == ProductRequest.ALLOCATED)
			{
				stop.setValue(true);
				dispose();
			}
			...
			{
				JOptionPane.showMessageDialog(this, "Still not Allocated !", "Warning", JOptionPane.WARNING_MESSAGE);
			}
		}
	}
